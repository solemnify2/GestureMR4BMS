...
## Info
   I have previously distributed Python scripts as a executable file built using PyInstaller for those who are not familiar with Python. However, there is currently an issue where executable files built with PyInstaller are being detected as viruses by Windows Defender. I am still unsure how to resolve this issue, so I will not be distributing these generated executable files. I am sorry for any inconvenience this may cause.
