...
2. **Install python libraries:** Open command prompt and run following
   ...
   ```
3. **Download and Run GestureMR4BMSGUI.py script before BMS launch:** Adjust camera position and detection area. Once you are satisfied, **uncheck** "View Webcam Feed" to minimize unnecessary overhead caused by this program.
