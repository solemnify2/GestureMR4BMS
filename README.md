...
## Usage
1. **Download Pre-built [Latest Release]([https://github.com/solemnify2/GestureMR4BMS/releases/download/v0.0.1/GestureMR4BMS-v0.0.1.exe](https://github.com/solemnify2/GestureMR4BMS/releases/download/v0.0.2/GestureMR4BMS.exe)). There is no installation package yet.**
